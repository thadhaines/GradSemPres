...
%------------------------------------------------
\begin{frame}
\frametitle{Balancing Authorities (BAs)}
\centering{
\href{https://www.eia.gov/realtime_grid/}%
{\includegraphics[width=\linewidth]{BAs}} % from https://www.eia.gov/realtime_grid/
}
\end{frame}
%------------------------------------------------
\begin{frame}
...
\begin{multicols}{2}
\centering{
{\includegraphics[height=.8\textheight]{timeScales}} % from p3. chow sauer pai , Power System Dynamics and Stability book
}\cite{SauerPaiChow}  \\
